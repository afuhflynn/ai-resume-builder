    ...
    <main className="container mx-auto max-w-4xl py-12 px-4 md:py-20 ">
      <div className="space-y-8">
        ...
        <div className="prose prose-lg dark:prose-invert mx-auto">
          <p>
            Welcome to Resumi ("we," "us," or "our"). We are committed to
          ...
          <ul>
            <li>
              ...
              collect names, email addresses, passwords, contact or
              authentication data, billing addresses, and other similar
              information.
            </li>
            <li>
              <strong>Resume Data:</strong> We collect the information you
              provide for your resumes, such as work history, education, skills,
            ...
            <li>
              ...
              stored by our payment processor, Stripe.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              information for the purposes of managing your account and keeping
              it in working order.
            </li>
            <li>
            ...
            <li>
              ...
              service, which includes generating resumes and providing
              AI-powered analysis.
            </li>
            <li>
              <strong>
          ...
          <p>
            ...
            business obligations. We may share your data with third-party
            ...
            (Stripe), data analysis, email delivery (Resend), hosting services,
            and AI service providers (OpenAI).
          </p>
